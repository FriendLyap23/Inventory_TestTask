...
namespace Assets.Inventory_TestTask
{
    public class InventoryService
    {
        ...
        public AddItemsToInventoryGridResult AddItemsToInventorySlot(string ownerId,
            Vector2Int slotCoords, string itemId, int amount = 1)
        {
            var inventory = _inventoriesMap[ownerId];
        ...
        public RemoveItemsFromInventoryGridResult RemoveItemsFromSlot(string ownerId,
            Vector2Int slotCoords, string itemId, int amount = 1)
        {
            var inventory = _inventoriesMap[ownerId];
